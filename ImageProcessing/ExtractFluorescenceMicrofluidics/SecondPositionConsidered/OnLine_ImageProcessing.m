...
switch answer
    case 'Yes'
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        disp('Now for the background: ')                        %
        [fil2,K2] = uigetfile([dir1, '\*']);                    % SECOND POSITION
        [cutcorBACK1, cutcorBACK2] = DICindexROIBackground(K2); %
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    case 'No'
        K2='';
        cutcorBACK1=[];
...
t.TimerFcn = {@ImProcSegm,cutcor,pDIC,ident,INP,CitFreq,DicFreq,datenow,bacpat,cutcorBACK1,cutcorBACK2};
