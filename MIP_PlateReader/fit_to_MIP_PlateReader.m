function [out] = fit_to_MIP_PlateReader(epccOutputResultFileNameBase,epcc_exps,global_theta_guess)
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    results_folder = strcat('InduciblePromoterPlateReader',datestr(now,'yyyy-mm-dd-HHMMSS'));
    short_name     = strcat('IndProm',num2str(epcc_exps));
 
    % Load experimental data
%     load('PlateReaderData.mat');
    
    load('PlateReaderDataReduced2.mat');
    Data = DataRed;
